...
def train_epochs(
        ...
        val_x: np.ndarray, 
        val_y: np.ndarray,
        epochs: int = 20) -> Tuple[int, float, list]:
    '''
    ...
    Returns:
        ...
        list: list of all accuracies over the given epochs
    '''
    ...
    for i in range(1, epochs + 1): 
        ...
        val_accuracy = accuracy(val_y, model.predict(val_x))
    ...
    return best_epochs, best_val_accuracy, epoch_accuracies
...
if __name__ == '__main__':
    ...
    best_epochs, best_accuracy, _ = train_epochs(
        model=model, 
        train_x=train_x, 
        train_y=train_y, 
        val_x=val_x, 
